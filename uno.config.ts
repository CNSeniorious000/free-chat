...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'gpt-title': 'text-lg font-extrabold sm:text-xl',
    'gpt-subtitle': 'bg-gradient-(from-emerald-400 to-sky-200 to-r) bg-clip-text text-lg text-transparent font-extrabold sm:text-xl',
