<script module lang="ts">
  ...
  type Model = 'qwen-qwq-32b' | 'DeepSeek-V3-0324' | 'DeepSeek-R1-Distill-Llama-70B' | 'THUDM/GLM-4-9B-0414' | 'internlm/internlm2_5-20b-chat' | 'gemma2-9b-it' | 'nous-hermes-2-mixtral-8x7b-dpo' | 'meta-llama/llama-4-maverick-17b-128e-instruct' | 'llama-3.3-70b' | 'llama3.1-70b' | 'azure:gpt-4o' | 'azure:gpt-4.1' | 'Phi-4' | 'Meta-Llama-3.1-405B-Instruct' | 'Mistral-small-2503' | 'Mistral-large-2411' | 'yi-lightning' | 'grok-3-beta' | 'grok-3-mini-beta' | 'gemma-3-27b-it' | 'gemini-2.0-flash-lite' | 'gemini-2.0-flash-thinking-exp' | 'MAI-DS-R1' | 'Cohere-command-a'
