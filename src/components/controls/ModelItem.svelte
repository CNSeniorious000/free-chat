<script module lang="ts">
  ...
  type Model = 'gpt-oss-120b' | 'glm-4.5-flash' | 'z-ai/glm-4.5-air:free' | 'glm-4.5v' | 'zai-glm-4.6' | 'qwen-3-32b' | 'qwen-3-235b-a22b-instruct-2507' | 'DeepSeek-V3.1' | 'DeepSeek-V3.1-Terminus' | 'THUDM/GLM-4-9B-0414' | 'THUDM/GLM-4-32B-0414' | 'Llama-4-Maverick-17B-128E-Instruct' | 'internlm/internlm2_5-20b-chat' | 'gemma2-9b-it' | 'nous-hermes-2-mixtral-8x7b-dpo' | 'meta-llama/llama-4-maverick-17b-128e-instruct' | 'llama-3.3-70b' | 'llama3.1-70b' | 'azure:gpt-4o' | 'azure:gpt-4.1-mini' | 'azure:gpt-4.1' | 'azure:o3' | 'azure:o4-mini' | 'azure:gpt-5-mini' | 'azure:gpt-5-chat' | 'Phi-4' | 'Meta-Llama-3.1-405B-Instruct' | 'Mistral-medium-2505' | 'Mistral-large-2411' | 'yi-lightning' | 'x-ai/grok-4.1-fast:free' | 'qwen/qwen3-coder:free' | 'grok-3-beta' | 'grok-3-mini-beta' | 'gemma-3-27b-it' | 'gemini-2.5-flash' | 'gemini-2.0-flash-lite' | 'gemini-2.5-pro' | 'Cohere-command-a' | 'deepseek/deepseek-chat-v3.1:free' | 'moonshotai/kimi-k2-instruct-0905' | 'x-ai/grok-4-fast:free' | 'MiniMax-M2' | 'deepseek-ai/DeepSeek-V3.2-Exp' | 'kwaipilot/kat-coder-pro:free' | 'alibaba/tongyi-deepresearch-30b-a3b:free' | 'meituan/longcat-flash-chat:free'
