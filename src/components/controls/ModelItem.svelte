<script module lang="ts">
  ...
  type Model = 'gpt-oss-120b' | 'glm-4.5-flash' | 'qwen-3-coder-480b' | 'qwen-3-235b-a22b-thinking-2507' | 'qwen-3-235b-a22b-instruct-2507' | 'DeepSeek-V3-0324' | 'deepseek-r1-distill-llama-70b' | 'THUDM/GLM-4-32B-0414' | 'internlm/internlm2_5-20b-chat' | 'gemma2-9b-it' | 'nous-hermes-2-mixtral-8x7b-dpo' | 'Llama-4-Maverick-17B-128E-Instruct' | 'llama-3.3-70b' | 'llama3.1-70b' | 'azure:gpt-4.1' | 'azure:o3' | 'azure:o4-mini' | 'azure:gpt-5-chat' | 'Phi-4' | 'Meta-Llama-3.1-405B-Instruct' | 'Mistral-medium-2505' | 'Mistral-large-2411' | 'yi-lightning' | 'grok-3-beta' | 'grok-3-mini-beta' | 'gemma-3-27b-it' | 'gemini-2.0-flash' | 'gemini-2.0-flash-thinking-exp' | 'Cohere-command-a' | 'DeepSeek-R1-0528' | 'moonshotai/kimi-k2:free'
