...
<div class="grid grid-cols-2 w-full justify-between gap-1.5 text-sm">
  ...
  <ModelItem id="allenai/olmo-3.1-32b-think:free" name="olmo-3.1-32b-think" title="🧠 开源的深度推理模型" />
  <ModelItem id="arcee-ai/trinity-mini:free" name="trinity-mini" title="arcee-ai 高效的开源模型" />
  <ModelItem id="nvidia/nemotron-3-nano-30b-a3b:free" name="nemotron-3-nano" title="NVIDIA 的开源模型" />
  <Hr text="低可用性模型（延迟较大）" />
