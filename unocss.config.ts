...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'gpt-title': 'text-2xl font-extrabold tracking-wide -mr-2',
    'gpt-subtitle': 'text-(2xl transparent) font-extrabold bg-(clip-text gradient-to-r) from-sky-400 to-sky-200',
