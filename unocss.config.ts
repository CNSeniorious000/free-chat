...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'gpt-retry-btn': 'fi gap-1 px-2 py-0.5 op-70 ring-0.4 ring-$c-fg-50 rounded-md text-sm cursor-pointer hover:bg-$c-fg-5 transition-background-color',
    ...
    'gen-slate-btn': 'h-12 px-4 py-2 bg-$c-fg-10 hover:bg-$c-fg-15 focus-visible:ring-1.5 ring-$c-fg-40 rounded-sm <sm:h-10 <sm:px-3 <sm:py-1 select-none transition-background-color outline-none',
    'gen-cb-wrapper': 'h-12 my-4 fcc gap-4 bg-$c-fg-10 rounded-sm <sm:h-10 <sm:text-sm',
    'gen-cb-stop': 'px-2 py-0.5 ring-1.2 ring-$c-fg-50 rounded-md text-sm op-70 cursor-pointer hover:bg-$c-fg-5 <sm:text-xs <sm:px-1 <sm:px-1.5 <sm:py-0.4 transition-background-color',
    'gen-text-wrapper': 'my-4 fc gap-2 transition-opacity items-end',
    'gen-textarea': 'w-full px-3 py-3 min-h-12 max-h-40vh rounded-sm bg-$c-fg-10 resize-none focus:(bg-$c-fg-15 ring-0 outline-none) placeholder:op-50 dark:(placeholder:op-30) scroll-pa-8px <sm:min-h-10 <sm:px-2 <sm:py-2 transition-background-color',
